-- Migration: persistent free-form info text per (slot_year, semester_type)
-- Backs the "Slot Information:" textarea on the View Master Slot TimeTable page.
...
COMMENT ON TABLE slot_info IS 'Persistent informational text shown below the master slot timetable, one row per (slot_year, semester_type).';
